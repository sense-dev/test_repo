 ...
 * @version $Id: LC_Page_Contact.php 23605 2014-08-27 09:45:58Z kimoto $
 */
...
//     }
    public function lfInitParam(&$objFormParam)
    {
    	$objFormParam->addParam('姓', 'name01', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
    	$objFormParam->addParam('名', 'name02', STEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
    	$objFormParam->addParam('咨询内容', 'contents', MLTEXT_LEN, 'KVa', array('EXIST_CHECK', 'MAX_LENGTH_CHECK'));
    	$objFormParam->addParam('电子邮箱', 'email', null, 'KVa', array('EXIST_CHECK', 'EMAIL_CHECK', 'EMAIL_CHAR_CHECK'));
    	$objFormParam->addParam('电子邮箱(确认用)', 'email02', null, 'KVa', array('EXIST_CHECK', 'EMAIL_CHECK', 'EMAIL_CHAR_CHECK'));
    	$objFormParam->addParam('电话号码', 'tel01', TEL_ITEM_LEN, 'n', array('NUM_CHECK'));
    }
