<?php /* Smarty version 2.6.27, created on 2015-07-12 22:57:08
         compiled from customer/edit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'customer/edit.tpl', 28, false),array('modifier', 'h', 'customer/edit.tpl', 43, false),array('modifier', 'default', 'customer/edit.tpl', 116, false),array('modifier', 'sfDispDBDate', 'customer/edit.tpl', 290, false),array('modifier', 'n2s', 'customer/edit.tpl', 292, false),array('function', 'sfSetErrorStyle', 'customer/edit.tpl', 82, false),array('function', 'html_radios', 'customer/edit.tpl', 83, false),array('function', 'html_options', 'customer/edit.tpl', 116, false),)), $this); ?>
...
<?php endif; ?> />
            ...
            <tr>
                <th>お名前(フリガナ)<?php if (! ((is_array($_tmp=@FORM_COUNTRY_ENABLE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?><span class="attention"> *</span><?php endif; ?></th>
                <td>
...
" maxlength="<?php echo ((is_array($_tmp=@STEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" size="30" class="box30" <?php if (((is_array($_tmp=$this->_tpl_vars['arrErr']['company_name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?><?php echo SC_Utils_Ex::sfSetErrorStyle(array(), $this);?>
<?php endif; ?> />
                </td>
            </tr>
