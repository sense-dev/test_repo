<?php /* Smarty version 2.6.27, created on 2015-07-12 16:34:26
         compiled from mail_templates/customer_mail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'mail_templates/customer_mail.tpl', 28, false),)), $this); ?>
　※本メールは自動配信メールです。
...
　ければ会員登録はなされません。
　またその旨 <?php echo ((is_array($_tmp=$this->_tpl_vars['CONF']['email02'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
 まで
　ご連絡いただければ幸いです。
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
