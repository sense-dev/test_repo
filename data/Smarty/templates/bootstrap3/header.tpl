            ...
            <div id="header_utility">
                ...
                <div id="header_navi" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            <br />
                            <a href="<!--{$smarty.const.HTTPS_URL}-->"><span class="font-size-md">首页</span></a>
                        </li>
                        <li class="mypage dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-header">
                                    <a href="<!--{$smarty.const.HTTPS_URL}-->mypage/login.php"><span class="glyphicon glyphicon-log-in"></span> 登录账号</a>
                                    <br />
                                    <span>还不是会员？<a href="<!--{$smarty.const.ROOT_URLPATH}-->entry/kiyaku.php">免费注册</a></span>
                                </li>
                                <!--{else}-->
                                <li class="divider"></li>
                                <li class="dropdown-header">
                                ...
                                <li>
                                    <a href="<!--{$smarty.const.HTTPS_URL}-->mypage/login.php"><span class="glyphicon glyphicon-user"></span> 我的信息页</a>
                                </li>
                                <li class="dropdown-header">
                                   	 设定
                                </li>
                                <li>
                                    <a href="<!--{$smarty.const.HTTPS_URL}-->mypage/change.php"><span class="fa fa-wrench"></span> 修改会员信息</a>
                                </li>
                                <li>
                                    <a href="<!--{$smarty.const.HTTPS_URL}-->mypage/delivery.php"><span class="fa fa-truck"></span> 修改送货地址</a>
                                </li>
                                <li class="divider"></li>
                                <li class="dropdown-header">
                                    不是<!--{$smarty.session.customer.name01}--><!--{$smarty.session.customer.name02}-->？
                                </li>
                                <li>
                                    <a href="<!--{$smarty.const.HTTPS_URL}-->frontparts/login_check.php?mode=logout"><span class="glyphicon glyphicon-log-out"></span> 退出账号</a>
                                </li>
                                <!--{/if}-->
                            </ul>
                        </li>
