...
<div id="mypagecolumn">
    ...
    <div id="mycontents_area">
        ...
        ※最多添加<span class="attention"><!--{$smarty.const.DELIV_ADDR_MAX|h}--></span>个地址。</p>
                ...
                <div class="list-group">
                    <!--{section name=cnt loop=$arrOtherDeliv}-->
                        ...
                        <div class="list-group-item">
                            <div class="row">
                                <div class="col-xs-7">
                                    <label for="add<!--{$smarty.section.cnt.iteration}-->">送货地址<!--{$smarty.section.cnt.iteration}--></label><br />
                                ...
                                <div class="col-xs-5 padding-right-none text-right">
                                    <a href="./delivery_addr.php" onclick="eccube.openWindow('./delivery_addr.php?other_deliv_id=<!--{$arrOtherDeliv[cnt].other_deliv_id}-->','deliv_disp','600','640'); return false;" class="btn btn-default btn-xs">变更</a>
